...
export const DashboardView: React.FC = () => {
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 bg-white p-5 rounded-2xl border border-slate-200/80 shadow-2xs">
        ...
        <div className="flex items-center gap-2 self-start md:self-auto">
          <button
            ...
            className="px-3.5 py-2 rounded-xl text-xs font-semibold bg-sky-600 hover:bg-sky-700 text-white shadow-xs hover:shadow transition-all flex items-center gap-2 cursor-pointer"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-2 border-b border-slate-200">
            <div>
              ...
              <p className="text-xs text-slate-500">
                Patients with multimodal patterns that may warrant clinical review.
              </p>
            </div>
        ...
        <div className="space-y-4">
          ...
          {/* Quick Practice Analytics Snapshot Card */}
          <div className="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-2xs space-y-3 text-xs">
            ...
            <div className="space-y-2 text-slate-600">
              <div className="flex justify-between items-center">
                <span>Pharmacy Refill Gaps (&gt;7d)</span>
                <span className="font-bold text-slate-800">14 patients (10.9%)</span>
              </div>
              ...
              <div className="flex justify-between items-center">
                <span>Symptom Spikes Following Gaps</span>
                <span className="font-bold text-slate-800">9 patients (7.0%)</span>
              </div>
              <div className="w-full bg-slate-100 h-1.5 rounded-full overflow-hidden">
              ...
              <div className="flex justify-between items-center">
                <span>Identified Alternative Explanations</span>
                <span className="font-bold text-amber-700">6 patients (4.6%)</span>
              </div>
              <div className="w-full bg-slate-100 h-1.5 rounded-full overflow-hidden">
